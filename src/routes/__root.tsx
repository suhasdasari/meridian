  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Meridian is a live world news desk. Headlines are shown as published. The lead story is the cluster with the most independent outlets. No ranking by ideology.",
      },
